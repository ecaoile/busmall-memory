...
new Product('Instant Clip-On Man Bun', '../img/instant-clip-on-man-bun.jpg', 'instant-clip-on-man-bun', 'Some guys have trouble growing hair, and that\'s okay. If you want a man bun but can\'t grown one out for whatever reason, this product is for you. It comes in a variety of natural and unnatural hair colors.');
new Product('Macho Tissues', '../img/macho-tissues.jpg', 'macho-tissues', 'We all know that real men don\'t cry. Even so, there are situation where you\'d want to use tissues. Sometimes you might bleed from doing something manly like a round of fistacuffs. Other times, you might be sweating after a long day of manly activities! Let everyone know that you only use tissues for blood and sweat, but never tears!');
...
new Product('Rubber Chicken Socks', '../img/rubber-chicken-socks-feet.jpg', 'rubber-chicken-socks-feet', 'Do you remember all the good times you had with a rubber chicken as a child? The wonderful music you made when you choked the chicken? Now you can wear these rubber chicken socks to remind of you the good ol\' days while looking stylish.');
...
new Product('World Domination Notebook', '../img/world-domination-notebook.jpg', 'world-domination-notebook', 'Do you need a discreet place to write out your plans for world domination? Even though you could type out your plans on a computer, that\'s not very safe! The government is watching you! Use this trusty notebook to write up all your devious plans in a secure place.');
